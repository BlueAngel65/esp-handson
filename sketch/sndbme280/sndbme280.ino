...
uint16_t dig_P1; 
 int16_t dig_P2;  int16_t dig_P3;  int16_t dig_P4;  int16_t dig_P5; 
 int16_t dig_P6;  int16_t dig_P7;  int16_t dig_P8;  int16_t dig_P9; 
 int8_t  dig_H1;  
 int16_t dig_H2;  int8_t  dig_H3;  int16_t dig_H4; 
 int16_t dig_H5;  int8_t  dig_H6;

extern void BME280_writeReg(uint8_t, uint8_t);
extern void BME280_readTrim();
extern void BME280_getData();
extern void BME280_readData();
extern signed long int calibration_T(signed long int);
extern unsigned long int calibration_P(signed long int);
extern unsigned long int calibration_H(signed long int);
...
void BME280_setup() { 
  ...
  BME280_writeReg(0xF2,ctrl_hum_reg); 
  BME280_writeReg(0xF4,ctrl_meas_reg); 
  BME280_writeReg(0xF5,config_reg); 
  BME280_readTrim();                     
} 
...
void BME280_writeReg(uint8_t reg_address, uint8_t data) { 
  Wire.beginTransmission(BME280_ADDRESS); 
